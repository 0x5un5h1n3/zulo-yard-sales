...
public class AllProductsAdapter extends RecyclerView.Adapter<AllProductsAdapter.MyAllProductViewHolder> {
    ...
    public AllProductsAdapter(List<Product> productList, Activity activity) {
