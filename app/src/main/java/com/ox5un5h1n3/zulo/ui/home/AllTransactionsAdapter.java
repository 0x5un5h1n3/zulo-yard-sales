...
public class AllTransactionsAdapter extends RecyclerView.Adapter<AllTransactionsAdapter.MyAllTransactionViewHolder> {

    private List<Product> mTransactionList;

    // getting list from the constructor
    public AllTransactionsAdapter(List<Product> TransactionList) {
